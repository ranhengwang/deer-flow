...
EVOLUTION_TRACE_EVENT = RunEventDefinition("skill_evolution.trace", "evolution")
...
EVOLUTION_RUN_EVENT_DEFINITIONS = (EVOLUTION_TRACE_EVENT,)

FIXED_RUN_EVENT_DEFINITIONS = (
    *JOURNAL_RUN_EVENT_DEFINITIONS,
    *SUBAGENT_RUN_EVENT_DEFINITIONS,
    *WORKSPACE_RUN_EVENT_DEFINITIONS,
    *EVOLUTION_RUN_EVENT_DEFINITIONS,
)
